...
public class CourseServiceImpl implements CourseService {
    ...
    public PageInfo<CourseVO> getCoursesByType(Integer currPage, Integer pageSize, Integer uid, String type) {
        if(currPage==null || currPage<1) currPage=1;
        PageHelper.startPage(currPage, pageSize);
//        List<Course> courseList = courseMapper.selectByType(type);
//        if(uid !=null && uid >0){
...
//        }
        ...
        PageInfo<CourseVO> ret = getCourseVOPageInfo(uid, po);
