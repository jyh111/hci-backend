...
public class CourseController {
    ...
    @PostMapping("/get_like/{courseId}")
    public ResultVO<CourseVO> getCourseLike(@RequestParam Integer uid, @PathVariable Integer courseId){
        return courseService.getCourseLike(uid, courseId);
    }
